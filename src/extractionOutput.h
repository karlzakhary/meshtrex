...
struct ExtractionOutput {
    ...
    Buffer globalVertexIDCounter{};
    Buffer filledMeshletDescriptorCountBuffer{};
    Buffer globalIndexOutputCount{};
    ...
    globalVertexIDCounter(std::move(other.globalVertexIDCounter)),
    filledMeshletDescriptorCountBuffer(std::move(other.filledMeshletDescriptorCountBuffer)),
    globalIndexOutputCount(std::move(other.globalIndexOutputCount)),
    ...
    void cleanup() {
        ...
        destroyBuffer(globalVertexIDCounter, device);
        destroyBuffer(filledMeshletDescriptorCountBuffer, device);
        destroyBuffer(globalIndexOutputCount, device);
        ...
        filledMeshletDescriptorCountBuffer = {};
