...
struct ExtractionOutput {
    ...
    // Buffer for indirect draw commands for rendering (generated by DGC from meshlet count)
    Buffer renderingIndirectDrawBuffer{};
    ...
    renderingIndirectDrawBuffer(std::move(other.renderingIndirectDrawBuffer)),
    ...
    void cleanup() {
        ...
        destroyBuffer(renderingIndirectDrawBuffer, device);
